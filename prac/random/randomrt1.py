...
def main():
    ...
    while not window_should_close():
        ...
        rec3copy = Rectangle(up_left[0]+2,int(up_left[1]+down_right_wh[1]/2)+4,int(down_right_wh[0]/2)-6,int(down_right_wh[1]/2)-6) 
        ...
        rec2 = Rectangle(up_left[0]+abs(20*cos(1.5*t)),up_left[1]+abs(20*cos(0.5*t)),down_right_wh[0],down_right_wh[1])        
        raylib.DrawRectangleLinesEx(rec2,2,RAYWHITE)
        drawgridinrectangle([up_left[0]+abs(20*cos(1.5*t)),up_left[1]+abs(20*cos(0.5*t))],down_right_wh,mashtab,razmer,1)
