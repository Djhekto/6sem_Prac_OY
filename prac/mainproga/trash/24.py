...
class MainWindow(QMainWindow):
    ...
    def ff1(self):
        ...
        #self.yslovia = list(map((map),(pravayachast1,[[self.txt_y1a.text(),self.txt_y1b.text()],
        #                [self.txt_y2a.text(),self.txt_y2b.text()],
        #                [self.txt_y3a.text(),self.txt_y3b.text()],
        #                [self.txt_y4a.text(),self.txt_y4b.text()]]  )))      
