#та же фигня, отображается ток один холст за раз
#пойду крч пайкутеграф читать мб поможет
...
class TestChart(QMainWindow):
    def __init__(self):
        ...
        self.canvasx12 = QPixmap(400, 300)
        self.canvasx12.fill()
        self.grafikx12.setPixmap(self.canvasx12)
        self.draw_x12()
        layout.addWidget(self.grafikx12,0,0)
        
        self.grafikx34 = QLabel()
        self.canvasx34 = QPixmap(400, 300)
        self.canvasx34.fill()
        self.grafikx34.setPixmap(self.canvasx34)
        self.draw_x34()
        layout.addWidget(self.grafikx12,2,0)        
        
        layout.addWidget(self.cictema,1,1)
        layout.addWidget(self.txt_fun,1,0)
    ...
    def draw_x34(self):
        canvas = self.grafikx34.pixmap()
        painter = QPainter(canvas)
        painter.drawLine(30, 300, 30, 10)
        painter.end()
        self.grafikx34.setPixmap(canvas)
