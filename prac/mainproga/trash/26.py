# need to get rid of a line linking 2 separate graphs on 1 plot
...
class MainWindow(QMainWindow):
    ...
    def ff1(self):
        ...
        self.plot1.clear()
        self.plot2.clear()
        #tempa = np.array([a for [a,b,c,d] in self.list4d_tocki], dtype=float)
        #tempb = np.array([b for [a,b,c,d] in self.list4d_tocki], dtype=float) 
        #tempc = np.array([c for [a,b,c,d] in self.list4d_tocki], dtype=float)
        #tempd = np.array([d for [a,b,c,d] in self.list4d_tocki], dtype=float)
        #print(tempa,tempb,tempc,tempd)
        self.plot1.plot(np.array([a for [a,b,c,d] in self.list4d_tocki], dtype=float),np.array([b for [a,b,c,d] in self.list4d_tocki], dtype=float), pen=pg.mkPen('r', width=4), name='old')
        self.plot2.plot(np.array([c for [a,b,c,d] in self.list4d_tocki], dtype=float),np.array([d for [a,b,c,d] in self.list4d_tocki], dtype=float), pen=pg.mkPen('r', width=4), name='old')
        self.plot1.plot(np.array([a for [a,b,c,d] in self.list4d_tocki_new], dtype=float),np.array([b for [a,b,c,d] in self.list4d_tocki_new], dtype=float), pen=pg.mkPen('b', width=4), name='new')
        self.plot2.plot(np.array([c for [a,b,c,d] in self.list4d_tocki_new], dtype=float),np.array([d for [a,b,c,d] in self.list4d_tocki_new], dtype=float), pen=pg.mkPen('b', width=4), name='new')
