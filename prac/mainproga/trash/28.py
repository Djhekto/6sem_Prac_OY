...
def euler4D_twodirections(symbols,yslovia,strfunlist,a,b,tz,ppp,shag=0.005):
    list4d_tocki_vlevo = []
    list4d_tocki_vpravo = []
    ...
    i=0
    tz_vlevo = eval(tz)
    while tz_vlevo>10*a:#tz_vlevo>a:
        list_append_me = []
        for ii in range(4):
    ...
    i=0
    tz_vpravo = eval(tz)
    while tz_vpravo<10*b:#tz_vpravo<b:
        list_append_me = []
        for ii in range(4):
...
def MPP_4D(symbols,yslovia,strfunlist,a,b,tz,ppp,shag=0.05):
    ppp1 = ppp
        ...
        try:
            ...
            for i,e in enumerate( Matr_F):
                #for ii,ee in enumerate(e):
                    if e!=0:
                        e = 1/e
            Matr_F = Matr_F.tolist()
            nyleviestroki = []
            for i in range(4):
                tempc = 0
                for ii in range(4):
                    if Matr_F[i][ii] == 0: tempc+=1
                if tempc >= 4:
                    nyleviestroki.append(i)

            print(nyleviestroki)
            Matr_Fc = [[]]
            for i in range(4):
                if i in nyleviestroki:
                    continue;
                else:
                    Matr_Fc.append(Matr_F[i])
            Matr_Fc = Matr_Fc[1:]
            print(Matr_Fc)

            nyleviestolbci = []
            for i in range(len(Matr_Fc[0])):
                tempc = 0
                for ii in range(len(Matr_Fc)):
                    if Matr_Fc[ii][i] == 0: tempc+=1
                if tempc >= len(Matr_Fc):
                    nyleviestolbci.append(i)
            print(nyleviestolbci)
            for i,stroka in enumerate(Matr_Fc):
                for elem in nyleviestolbci:
                    Matr_Fc[i] =  Matr_Fc[i][0:elem:]
            print(Matr_Fc)
            #Matr_Fc = ((-1)*Matrix(Matr_Fc).inverse_CH()).tolist()
            #Matr_Fc = Matrix(Matr_Fc).inv().tolist()
            Matr_Fc = Matrix(Matr_Fc).inv()#.tolist()
            #for i,e in enumerate(Matr_Fc):
            #    Matr_Fc[i] = 1/Matr_Fc[i]
            Matr_Fc = Matr_Fc.tolist()
            print(Matr_Fc)
            for i,stroka in enumerate(Matr_Fc):
                for elem in nyleviestolbci:
                    Matr_Fc[i] =  Matr_Fc[i][0:elem]+[0]+Matr_Fc[elem:]
            print(Matr_Fc)
            for elem in nyleviestroki:
                Matr_Fc =  Matr_Fc[0:elem]+[[0,0,0,0]]+Matr_Fc[elem:]
            print(Matr_Fc)
            Matr_F = Matrix(Matr_Fc)
...
def vnytr_zadacha_4D(symbols,yslovia,strfunlist,t,tz,ppp,shag=0.005):
