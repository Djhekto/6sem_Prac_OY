...
# база лютая для фикса #https://stackoverflow.com/questions/40809503/python-numpy-typeerror-ufunc-isfinite-not-supported-for-the-input-types
...
class MainWindow(QMainWindow):
    ...
    def ff1(self):
        ...
        self.plot1.plot(tempa,tempb)
        #self.plot2.plot(tempc,tempd)
        #data = np.array([1, 2, 3, 4, 5])
        #self.plot1.plot(data, data*100)
