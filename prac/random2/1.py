...
#грид надо было от начала коорд считать а не от края 
...
def main():
    ...
    up_left = [2,2]
    down_right = [302,302]
    up_left,down_right_wh = grid_mashtab(up_left,down_right,mashtab_grid)
    ...
    while not window_should_close():
        ...
        clear_background((230,230,255,255))
        raylib.rlSetLineWidth(3)
        
        drawgridinrectangle(up_left,down_right_wh,mashtab_grid,razmer,1)
