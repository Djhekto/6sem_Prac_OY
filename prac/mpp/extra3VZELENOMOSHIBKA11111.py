...
#==================================================================================================================
    ...
    draw4 = euler(f1x1+"*"+enc(const_koef1),f2x2+"*"+enc(const_koef2),x1_,x2_,2000,0.1,wWidth)
    draw4a = euler(f1x1+"*"+enc(const_koef1),f2x2+"*"+enc(const_koef2),x1_,x2_,2000,-0.1,wWidth)
    ...
    draw8 = euler(f1x1+"*"+enc(const_koef1),f2x2+"*"+enc(const_koef2),x1_,x2_,2000,0.1,wWidth)   
    draw8a = euler(f1x1+"*"+enc(const_koef1),f2x2+"*"+enc(const_koef2),x1_,x2_,2000,-0.1,wWidth)   
    ...
    while not window_should_close():
        ...
        draw_text(f1x1+"*"+enc(const_koef1), wWidth-400, 310, 20, GREEN)
        draw_text(f2x2+"*"+enc(const_koef2), wWidth-400, 340, 20, GREEN)    
