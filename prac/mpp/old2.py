...
#    ifx1  = str(integrate(fx1,dx1,dx2,manual=True))
#    ifx2  = str(integrate(fx2,dx1,dx2,manual=True))
#    print(ifx1,ifx2)
    

#    test = ifx1.replace("x1",str(x1_)).replace("x2",str(x2_))
#    test1= ifx2.replace("x1",str(x1_)).replace("x2",str(x2_))
#    print(test,test1,eval(test),eval(test1))
