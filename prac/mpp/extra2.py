...
def main():
    ...
    draw4 = euler(f1x1+"*"+enc(const_koef1),f2x2+"*"+enc(const_koef2),x1_,x2_,1000,0.1,wWidth)
    x1_ = x1_*(-1)
    x2_ = x2_*(-1)
    draw5 = euler(constf1,constf2,x1_,x2_,1000,0.1,wWidth)    
    draw6 = euler(constx1,constx2,x1_,x2_,1000,0.1,wWidth)    
    draw7 = euler(f1x1,f2x2,x1_,x2_,1000,0.1,wWidth)    
    draw8 = euler(f1x1+"*"+enc(const_koef1),f2x2+"*"+enc(const_koef2),x1_,x2_,1000,0.1,wWidth)   
