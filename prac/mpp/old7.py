...
#==================================================================================================================
    ...
    draw9 = euler(enc(constx1)+"*"+enc(const_koef1),enc(constx2)+"*"+enc(const_koef2),x1_,x2_,2000,shagt,wWidth)    
    draw9a = euler(enc(constx1)+"*"+enc(const_koef1),enc(constx2)+"*"+enc(const_koef2),x1_,x2_,2000,-shagt,wWidth) 
    ...
    draw10 = euler(enc(constx1)+"*"+enc(const_koef1),enc(constx2)+"*"+enc(const_koef2),x1_,x2_,2000,shagt,wWidth)    
    draw10a = euler(enc(constx1)+"*"+enc(const_koef1),enc(constx2)+"*"+enc(const_koef2),x1_,x2_,2000,-shagt,wWidth) 
