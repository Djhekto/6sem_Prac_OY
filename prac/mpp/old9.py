...
#==================================================================================================================
    ...
    draw_f = euler(drawx1,drawx2,x1_,x2_,kolvoshagov,shagt,wWidth)
    draw_f_obr = euler(drawx1,drawx2,x1_,x2_,kolvoshagov,-shagt,wWidth)        
    ...
    while not window_should_close():
        ...
        raylib.DrawLineStrip(draw_f, len(draw_f), GREEN)
        raylib.DrawLineStrip(draw_f_obr, len(draw_f_obr), GREEN)
